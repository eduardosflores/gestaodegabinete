...
--
-- Table structure for table `gab_calendar_key`
--
...
CREATE TABLE `gab_vereador` (
  ...
  `GAB_CARGO_POLITICO_cod_car_pol` int(10) unsigned DEFAULT NULL,
  `nom_orgao` varchar(150) DEFAULT NULL,
  ...
  KEY `fk_cod_car_pol` (`GAB_CARGO_POLITICO_cod_car_pol`),
  CONSTRAINT `fk_cod_car_pol` FOREIGN KEY (`GAB_CARGO_POLITICO_cod_car_pol`) REFERENCES `gab_cargo_politico` (`cod_car_pol`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

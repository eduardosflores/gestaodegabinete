            ...
            <div class="container" id="main">
                ...
                echo "action_cad_pessoa.php?mod=1";} else {echo "action_cad_pessoa.php";} ?>" method="post" autocomplete="off">
                    ...
                    <?php if($_SESSION['ind_pessoa'] == "PF"){ ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="email" autocomplete="on">Apelido:</label>
                            <div class="col-md-5">
                                <input id="nome" name="nom_apelido" type="text" placeholder="" class="form-control input-md"
                    ...
                    <?php } else { ?>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="email" autocomplete="on">Nome Fantasia:</label>
                            <div class="col-md-5">
                                <input id="nome" name="nom_apelido" type="text" placeholder="" class="form-control input-md"
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="email">Representante/Contato:</label>
                            <div class="col-md-5">
                                <input name="nom_re" type="text" placeholder="" class="form-control input-md"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input  name="nom_ocupacao" type="text" placeholder="" class="form-control input-md"
                ...
                if (isset($_GET['pesquisa'])){
                    ...
                    if(isset($_GET['ind_pessoa'])){
                        ...
                        if ($results = $mysqli->query($select_qry))
                        {
                            ...
                            $select_qry="select cod_pessoa, ind_pessoa, nom_nome, nom_apelido, cod_cpf_cnpj, cod_rg, cod_ie, nom_email, num_ddd_tel, num_tel, num_ddd_cel, num_cel, nom_re from gab_pessoa where ind_status='A' and ind_pessoa='$ind_pessoa'";
                    ...
                    if (count($records)){?>
                        ...
                        <table id="example" class="mtab table table-striped table-hover table-responsive" cellspacing="0" >
                            ...
                            <tr>
                                ...
                                <th>Nome</th>
                                <th><?php
                                    if ($ind_pessoa == "PF"){ echo "CPF"; }
                                    if ($ind_pessoa == "PJ"){ echo "CNPJ"; }
                                ?></th>
                                <!-- <th><?php
                                    if ($ind_pessoa == "PF"){ echo "RG"; }
                                    if ($ind_pessoa == "PJ"){ echo "IE"; }
                                ?></th> -->
                                <th>Email</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td  width='15%'>
                                        <?php
                                              if (!empty($r->cod_cpf_cnpj)){ echo escape($r->cod_cpf_cnpj); }
                                        ?>
                                    </td>
                                    <td  width='10%'>
                                        <?php
                                            $cod_rg= preg_replace('/([A-Za-z0-9]{2})([A-Za-z0-9]{3})([A-Za-z0-9]{3})([A-Za-z0-9]{1})/',"$1.$2.$3-$4",$r->cod_rg);
                                            if($r->ind_pessoa == "PF" && !empty($cod_rg)){ echo escape($cod_rg); }
                                            if($r->ind_pessoa == "PJ" && !empty($r->cod_ie)){ echo escape($r->cod_ie); }
                                        ?>
                                    </td>
                                    <?php
                                    ...
                                    <td  width='20%'><?php echo escape($num_ddd_tel)." ".escape($num_tel);?><br><?php echo escape($num_ddd_cel)." ".escape($num_cel);?></td>

                                    <?php $cod_pessoa=$r->cod_pessoa;?>
                                    <td style="text-align:center;" width='7%'><a href="form_cad_pessoa.php?alt=1&cod_pessoa=<?php echo $cod_pessoa; ?>"><i class="fas fa-pencil-alt" style="font-size:20px; color:000000;"></i></a></td>
                                    <td style="text-align:center;" width='7%'><a href="action_cad_pessoa.php?del=1&cod_pessoa=<?php echo $cod_pessoa; ?>" onclick="return confirm('Confirma exclusão?');"><i class="fas fa-trash-alt" style="font-size:20px; color:000000;"></i></a></td>
                                </tr>
                                <?php
                                }
                                ?>
